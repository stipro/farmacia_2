...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            Sistema de Punto de Venta para Farmacia            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'products')? 'active' : '' ?>" href="./?page=products">Productos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'stocks')? 'active' : '' ?>" href="./?page=stocks">Inventario</a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'sales_report')? 'active' : '' ?>" href="./?page=sales_report">Ventas</a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
